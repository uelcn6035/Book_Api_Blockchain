...
import { getBookData } from "../api/actions";
...
const BookCard: React.FC = () => {
  ...
  const [buttonText, setButtonText] = useState("Match a Pool");
          ...
          <div className="flex flex-col items-center">
            ...
            {!isPaymentComplete && !showContent && (
              <>
                ...
                {!isPaymentComplete && (
                  <Button className="mt-4" color="primary" onClick={handleBorrow} disabled={isBorrowLoading}>
                    {isBorrowLoading ? 'Processing...' : 'Borrow book for 10 algo'}
                  </Button>
                )}
              </>
            )}
